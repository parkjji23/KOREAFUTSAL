...
public class Res_statusService implements Cominterface{
	static Res_statusService impl = new Res_statusService();

	public static Res_statusService instance() {
		return impl;
	...
	public String showData(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		return "reservation.do?command=paymentsuccess";
	}
