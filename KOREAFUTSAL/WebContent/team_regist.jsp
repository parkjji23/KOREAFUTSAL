	...
	<section id="main">
		<section id="mainright">
			<div id="matList">
				...
				<div class="cbox">
					<div class="write_wrap" style="margin-bottom: 100px;">
						<h4 class="h_bar line">팀 등록</h4>
						<form name="reg_form" id="reg_form" method="post" enctype="multipart/form-data" action="regist.do?command=team_regist" role="form"
							autocomplete="off" >
						<div class="fl_wrap">
							<dl class="fl_left">
								<dt>팀분류</dt>
