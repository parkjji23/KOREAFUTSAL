...
<body>
	<%
		...
		if (uss.equals("GUEST")) {
			out.println("<script>alert('로그인 후 이용해주시기 바랍니다.');location.href='matyong.do?command=matchapply';</script>");
					...
					<div class="write_wrap">
						...
						<div class="container" id="formInnerWrapper"
							...
							<form name="matchjoin" id="materialForm" class="form"
								method="post" action="matchsignInsert.jsp?fn=1"
								role="form" autocomplete="off" style="margin-top: 30px;">
								<div class="form-group">

									<div class="col-xs-4">
										<select id="m_b_branch" name="m_b_branch" class=formInput>
									...
									function whenSuccessbranch(resdata) {
										var groundselectbox = $("#m_b_ground");
									...
									<div class="col-xs-4">
										<select name="m_b_ground" id="m_b_ground" class=formInput>
