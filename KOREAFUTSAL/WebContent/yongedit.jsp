...
<header>
	...
	<div id="mainleft" style="height:700px;">
		...
		<section id="mainright">
			<div id="matList">
				<div class="container" id="formOutterWrapper">
					<center>
						  <div class="writeboardtitle" style="text-align: center; font-size: 50px; "><%out.println(id);%>의 용병 수정</div>
					</center>
					<div class="container" id="formInnerWrapper">
						<form name="yongjoin" id="materialForm" class="form" method="post" action="yongsignInsert.jsp?fn=2&y_b_no=<%=index%>" role="form" autocomplete="off"><div class="form-group">
								<div class="col-xs-2"></div>
								<div class="col-xs-4">
									<select name="y_b_branch" class=formInput>
							...
							<div class="form-group">
								...
								<div class="col-xs-1">
									<label class="labels" for="y_b_tel2"></label> <input type="text" class="formInput" id="y_b_tel2" name="y_b_tel2" style="font-size:18px;">
								</div>
								<div style="float: left;">-</div>
								<div class="col-xs-1">
							...
							<div class="form-group" style="height:130px;">
								...
								<div class="col-xs-4">
									...
									<textarea name="y_b_contents" id="y_b_contents" style="width:730px;resize:none; height:200px;" placeholder="메모를 입력하세요." ></textarea>
								</div>
								...
								<div class="col-xs-4" style="margin-left: 45px;">
									...
									<input type="button" value="수정" class="signbutton signbutton5" onClick="yongjoinsubmit()" style="font-size:18px; width:140px; letter-spacing:5px;">
							<input type="button" value="취소"
								class="signbutton signbuttoncancel"
								style="font-size: 18px; width: 140px; letter-spacing: 5px;"
								onClick="script:location.href='yonglist.do?command=yonglist'">
						</div></div>
...
<%}
	...
	if(acc>=1&&!id.equals("null")){
	acc=0;
	out.println("<script>alert('게시글이 삭제되었습니다.');location.href='yonglist.do?command=yonglist';</script>");
	out.println(id+edit);
	yl.delete(index);
