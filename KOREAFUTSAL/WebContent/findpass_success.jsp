...
<%
	...
	String uss = (String)request.getAttribute("id");
	String log = "로그인";
	if(uss==null)
		uss="GUEST";
	 else{
...
<link rel="stylesheet" type="text/css" href="css/findpass_successCss.css">
...
<script src="https://code.jquery.com/jquery-2.2.3.min.js2020-01-02" integrity="sha256-a23g1Nt4dtEYOj7bR+vTu7+T8VP13humZFBJNIYoEJo=" crossorigin="anonymous"></script>
<script src="js/materialForm.js"></script>
					...
					<div class="container" id="formInnerWrapper">
						<form name="join" id="materialForm" class="form" method="post" action="sign.jsp" role="form" autocomplete="off">
							...
							<div class="form-group">
								<div>
									<input type="button" value="메인 화면으로 돌아가기" class=fbtn onClick="location.href='koreafutsal.cafe24.com';" style="width: 100%;">
								</div>
							</div>
						</form>
					</div>
