			...
			<div id="matList">
				...
				<div class="cbox">
					<div class="write_wrap">
						<h4 class="h_bar line">참가신청</h4>
						<form name="reg_form" id="reg_form" method="post" action="league_team_step3.do?command=league_team_step3">
						...
						$(document).ready(function() {
							...
							function league_step2_teamcheck() {
								$.ajax({
									type : "post",
									url : "./leaguestep2submit.do?command=leagueteamstep2teamcheck",
									dataType : "json",
									data : {
							...
							function whenSuccesscheck(resdata) {
								...
								if(leagueteamresult=="true"){ //이미 리그에 같은 팀이 등록되어있음 
									
									alert("이미 같은 리그에 등록된 팀입니다.");
								}else{
									reg_form.submit();
								}
