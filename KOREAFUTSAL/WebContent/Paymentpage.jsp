...
<%
	...
	session.getAttribute("ground_no");
	...
	int res_no =(int)request.getAttribute("res_no");
%>
		...
		<section id="mainright">
			<div id="matList">
				...
				<form action="reservation.do?command=resstatus_update" method="post">
					<center>
						<h1 style="font-weight: bold;">결제할 내용을 확인하세요</h1>
						<br />
					</center>
					<hr />
					<center>
						<table class="resulttable">
							...
							<tr>
								...
								<td><%=branch_name%></div></td>
							</tr>
							<tr>
								<td class="td1style">구장</td>
								<td><%=ground_name%></div></td>
							</tr>
							<tr>
					...
					<center>
					<input type="submit" value="결제진행" class="signbutton signbutton5" style="width: 145px;float:right;margin-top:40px;">
							<!-- res_status를 10->20으로-->
					<input type="button" value="나중에결제" class="signbutton signbutton5"
					onClick="script: location.href='Mypage.jsp'"
					style="width: 182px;float:right;margin-top:50px;"><!-- 혹은 이전으로 버튼 -->
					</center>
						</form>
				</div>
