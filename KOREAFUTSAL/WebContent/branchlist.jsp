...
<img src=<%if (convenarr[5].contains("o")) {%> "img/shoes_o.png"<%}
							...
							<tr>
								<td style="padding-left: 20px; font-size: 17px;font-weight:bold;"><img src="img/iconlocation.png" style="padding-right: 12px;"> <!-- 지점주소 --><%=BranchList.get(i).getBranch_location()%></td>
							</tr>
							<tr>
								<td style="padding-left: 20px; font-size: 17px; letter-spacing: 2px;font-weight:bold;"><img src="img/iconphone.png" style="padding-right: 12px;"> <!-- 지점전화번호 --><%=BranchList.get(i).getBranch_tel()%></td>
							</tr>
							<tr>
								<td>
								<input type="button" value="지점소개"
								onclick="script: location.href='branchlist.do?command=branchdetail&branch_no=<%=BranchList.get(i).getBranch_no()%>'"
								...
								style="float: left;" onclick="script: location.href='branchlist.do?command=reservationclick&branch_no=<%=BranchList.get(i).getBranch_no()%>'">
								</td>
							</tr>
						</tbody>
