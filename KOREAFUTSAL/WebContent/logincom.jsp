...
<body style="height:96%;">
			...
			<div id="matList" style="height:93%;">
				<div class="container" id="formOutterWrapper">
					<div class="container" id="formInnerWrapper" style="width: 1200px;">
						<form name="join" id="materialForm" class="form" method="post" action="mypage.do?command=signmodify" role="form" autocomplete="off">
							...
							<div class="form-group">
								<div class="col-xs-2"></div>
								<div class="col-xs-3" style="width:264px">
								...
								<div class="col-xs-1" style="width:46px">@</div>
								<div class="col-xs-3" style="width:264px">
							...
							<div class="form-group">
								...
								<div class="col-xs-6">
									<select id="second_pw" name="second_pw" size="1" class=formInput style="width:400px; height: 30px; margin-left:-15px;" value="<%=list.get(0).getSecond_pw()%>">
