			...
			<div id="matList">
				...
				<div class="cbox">
					<div class="league_cont team">
						...
						<input class="signbutton signbutton5" type="button" value="가입신청" style="float: right; margin: 10px;" onClick=team_apply_check('<%=uss%>');>
						...
						<div class="detail_score team">
							...
							<div class="table_wrap indi">
								<table>
									...
									<tbody>
										<tr>
											<td rowspan="4" class="pic"><span class="pic emblem"><img
													src="img/<%=TeamList.get(0).getT_logo()%>" alt=""></span></td>
										...
										<tr>
											...
											<td>Home :<%=TeamList.get(0).getT_uniform_home()%><br>Away
												: <%=TeamList.get(0).getT_uniform_away()%></td>
										</tr>
									</tbody>
								</table>
							</div>
						...
						<div class="tab_wrap">
							<ul class="t04">
								<li class="on"><a href="team_info.do?command=teaminfo&teamcode=<%=TeamList.get(0).getT_code()%>">팀일정</a></li>
								<li><a
									href="team_ranking.do?command=teamranking&teamcode=<%=TeamList.get(0).getT_code()%>">팀순위</a></li>
								<li><a
									href="team_player.do?command=teamplayer&teamcode=<%=TeamList.get(0).getT_code()%>">선수명단</a></li>
								<li><a
						...
						<div class="league_schedule">
							<form name="form" method="get" action="?">
								<input type="hidden" name="tcode" value="T1769"> <span
									class="select"> <label for="select01">2020년</label> <select
									id="select01" name="lyear" class="select_box"
