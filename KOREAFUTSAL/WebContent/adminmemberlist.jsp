		...
		<section id="mainright" style="height: 75%;">
			<div id="matList">
				<div class="sec_ban2">
					<ul class="nav_ban">
						<li><h3
								style="margin-bottom: 30px; margin-top: 5px; font-size: 50px; font-family: 'NanumBarunGothicL'; line-height: 60px; text-align: center;">회원 정보</h3></li>
					</ul>
				</div>
						...
						<thead>
							<tr id="tabletitle">
								<th scope="col" class="thno"><span> ID </span></th>
								<th scope="col" class="thtitle" style="text-align: center"><span>
										이름 </span></th>
								<th scope="col" class="thname" style="padding-right: 45px;"><span>전화번호 </span></th>
								<th scope="col" class="thname"style=" padding-right: 45px;    padding-left: 3px;"><span>이메일 </span></th>
				...
				<div class="cbox2" style="height: 600px;overflow-y:scroll;    padding-top: 0px;" >
					<table class="table table-striped">
						...
						<tbody >
								...
								<a>
									<tr>
										<td class="thgongji" style="text-align: left;"><%=MemberList.get(i).getId()%></td>
										<td class="thtitle"><a class="button" id="listtt" href="admin_member_view.adm?command=admin_member_view&id=<%=MemberList.get(i).getId()%>">
										<%=MemberList.get(i).getName()%></a> </td>
										<td class="thname" name="thname" id="thname"><%=MemberList.get(i).getTel()%></td>
										<td class="thname" name="thname" id="thname"><%=MemberList.get(i).getEmail()%></td>
