					...
					<div class="container" id="formInnerWrapper">
						<form name="join" id="materialForm" class="form" method="post"
							...
							<div class="form-group" style="">
								...
								<div class="col-xs-3" style="margin-left: 90px;margin-bottom: 90px;width: 330px;">

									<input type="button" value="가입" class="signbutton signbutton5" onclick="joinsubmit()" style="
    width: 142px;
    height: 58px;
"> <input type="button" value="취소" class="signbutton signbuttoncancel" onclick="script: location.href='sign.jsp'" style="
    width: 142px;
    height: 58px;
">
								</div>
