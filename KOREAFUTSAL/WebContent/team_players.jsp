				...
				<div class="cbox">
					...
					<div class="tab_wrap">
						<ul class="t04">
							...
							<li class="on"><a href="team_player.do?command=teamplayer&teamcode=<%=TeamList.get(0).getT_code()%>">리그선수명단</a></li> 
							<li><a
					...
					<div class="league_schedule">
						...
						<div class="table_wrap">
							<table>
							<caption>선수명단 테이블</caption>
							<colgroup>
								<col style="width:80px" class="w01">
								<col style="">
								<col style="width:180px" class="tb">
								<col style="width:150px" class="w02">
								<col style="width:150px" class="w03">
								<col style="width:150px" class="w05">
								<col style="width:150px" class="w06">
							</colgroup>
							...
							<thead>
								<tr>
									...
									<th scope="col">포지션</th>
									<th scope="col" class="tb">이름</th>
									<th scope="col"><a href="/league/team_players.asp?tcode=T1769&amp;lyear=2020&amp;stats=p"><span class="up">출전</span></a></th>
									<th scope="col"><a href="/league/team_players.asp?tcode=T1769&amp;lyear=2020&amp;stats=g"><span class="down">득점</span></a></th>
									<th scope="col"><a href="/league/team_players.asp?tcode=T1769&amp;lyear=2020&amp;stats=w"><span class="up">경고</span></a></th>
									<th scope="col"><a href="/league/team_players.asp?tcode=T1769&amp;lyear=2020&amp;stats=e"><span class="up">퇴장</span></a></th>
								</tr>
							</thead>
							<tbody>
							...
							<%}else{
								...
								<tr>
									...
									<td class="tb">
										...
										<div class="pic_wrap">
											<a href="#">
												<span class="pic"><img src="img/<%=MemberList.get(i).getPic() %>" alt="" style="width:55px; height:71px;"></span> 
												<span class="name"><%=MemberList.get(i).getName()%></span>
											</a>
										</div>
									</td>
