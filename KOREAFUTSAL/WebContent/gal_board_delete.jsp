...
<%
	int GB_NUM = (Integer) request.getAttribute("GB_NUM");
		...
		<section id="mainright">
			<div id="matList">
				...
				<div class="container" id="formOutterWrapper">
					<center>
						<div class="writeboardtitle ">게시글을 삭제하시겠습니까?</div>


						<form name="deleteForm" action="galDeletePro.bo?GB_NUM=<%=GB_NUM%>" method="post">
							<input type="hidden" name="page" value="<%=nowPage%>" />
						
						 <div class="form-group">
						 <div class="col-xs-3" style="margin-left:50px;"></div>
								<div class="col-xs-5">
						 <input name="GB_ID" type="text" class="margin1 formInput" placeholder="아이디를 입력하세요"><br>
						 </div>
						 </div>
						 ...
						 <div class="form-group">
								...
								<div class="col-xs-4 buttonmargin">
									...
									<input type="submit" value="삭제" onclick="modifyboard()" class="signbutton signbutton5 buttongal" style="font-size: 15px;">
									<input type="button" value="뒤로" onClick="history.go(-1)"class="signbutton signbuttoncancel buttongal margin3" style="font-size: 15px; margin-top:14px;">
								</div>
							</div>
