	...
	<section id="main">
		<section id="mainright">
			<div id="matList">
				...
				<h3 class="h_tit">Q&A관리</h3>
				
				<div class="table_wrap list">

						<table>
						<colgroup>
							<col style="width:66px" class="w01">
							<col style="width:352px;text-align: center;padding-left: 10px;">
							<col style="width:76px" class="w02">
							<col style="width:45px" class="tb">
							<col style="width:84px" class="tb">
						</colgroup>
					...
					<table>
						<tbody>
									...
									<%
										...
										%>
										<tr>
									    <td class="tb" style="width: 70px;"><%=Qnalist.get(i).getQ_b_no()%></td>
										<td class="al_left" style="padding-left: 10px;text-align-last: center;width: 400px;">
									 	<a href=qnadetail.adm?command=AdminQnADetail&q_b_no=<%=Qnalist.get(i).getQ_b_no()%>><%=Qnalist.get(i).getQ_b_title()%></a>
										</td>
										<td style="text-align: center;padding-right: 0px;width:70px;"><%=Qnalist.get(i).getQ_b_date()%></td>
										<td style="width: 70px;"><%=Qnalist.get(i).getQ_b_name()%></td>
										<td style="width: 70px;" class="tb"><%=Qnalist.get(i).getQ_b_readcount()%></td>
										</tr>
