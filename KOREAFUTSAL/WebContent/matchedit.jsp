				...
				<div class="container" id="formOutterWrapper">
					...
					<div class="write_wrap">
						...
						<div class="container" id="formInnerWrapper"
							...
							<form name="matchedit" id="materialForm" class="form" method="post" action="matchsignInsert.jsp?fn=2&m_b_no=<%=index%>" role="form" autocomplete="off"><div class="form-group">
						...
						<div class="btn_wrap">
							...
							<a href="matchapply.do?command=matchapply"
...
<%}
	...
	if(acc>=1&&!id.equals("null")){
	acc=0;
	out.println("<script>alert('게시글이 삭제되었습니다.');location.href='matchapply.do?command=matchapply';</script>");
	out.println(id+edit);
	ml.delete(index);
