		...
		<section id="mainright">
			<div id="matList">
				<div class="container" id="formOutterWrapper">
					<form action="reservation.do?command=resstatus_update" method="post">
						<center>
							<h1 style="font-weight: bold;">결제가 완료되었습니다</h1>
							<br />
						</center>
						<hr />
						<center>
							<table class="resulttable">
								<tr>
									...
									<td><%=ReservationList.get(0).getId()%></td>
								</tr>
								<tr>
									<td class="td1style">지점</td>
									<td><%=BranchList.get(0).getBranch_name()%></td>
								</tr>
								<tr>
									<td class="td1style">구장</td>
									<td><%=GroundList.get(0).getGround_name()%></td>
								</tr>
								<tr>
									<td class="td1style">날짜</td>
									<td><%=ReservationList.get(0).getRes_date()%></td>
								</tr>
								<tr>
									<td class="td1style">시간</td>
									<td><%=ReservationList.get(0).getRes_time()%></td>
								</tr>
								<tr>
									<td class="td1style">결제금액</td>
									<td><%=ReservationList.get(0).getPayment_charge()%>(원)</td>
								</tr>
							</table>
						</center>
						<hr />
						...
						<center>
							<input type="button" value="대관내역보기" class="signbutton signbutton5" onClick="script: location.href='Mypage.jsp'" style="width: 185px; float: right; margin-right: 485px;;margin-top: 40px;">
						</center>
					</form>
				</div>
