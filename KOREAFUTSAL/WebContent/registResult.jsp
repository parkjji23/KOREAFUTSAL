...
<%
	...
	String t_email = (String)request.getAttribute("t_email");
		...
		<section id="mainright">
			<div id="matList">
				<div class="container" id="formOutterWrapper">
					...
					<br />
					<center>
						<input type="button" value="메인으로" class="signbutton signbutton5" onClick="script: location.href='teamlist.do?command=teamlist'" style="width: 250px;">
					</center>
