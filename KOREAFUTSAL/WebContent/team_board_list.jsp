		...
		<section id="mainright">
			<div id="matList">
					...
					<table class="table table-striped margin2">
						...
						<tbody>
							...
							<tr>
								...
								<td class="thtitle"><a href=noticeboard.do?command=noticeboard_view&n_num=<%=noticelist.get(i).getN_num()%>> <%=noticelist.get(i).getN_title()%></a></td>
								<td class="thname"><%=noticelist.get(i).getAdmin_name()%></td>
								<td class="thdate"style="width: 96px;"><%=noticelist.get(i).getN_date()%></td>
				...
				<div id="galtablenav">
					...
					<input type="button" value="글쓰기" class="signbutton signbutton5 buttonmargin" onClick="script: location.href='teamboardlistwrite.do?command=team_board_list_writeform&id=<%=uss %>'" style="margin-right: 34px;">
				...
				<div class="container" style="width: 1193px;">
					...
					<div class="teams_table" style="clear:both;width: 950px;">
						...
						<div class="search">
							<form name="frm_search" method="post" action="teamboardsearch.do?command=teamboardlist">
									   ...
									   for(int i=0; i<teamboardlist.size(); i++){ %>
										<tr>
											...
											<td><div class="emb_wrap">
													<a href="teamboarddetail.do?command=teamboarddetail&teamBoardNo=
														<%=teamboardlist.get(i).getT_B_NO()%>">
													<span class="team"><%=teamboardlist.get(i).getT_B_SUBJECT()%>
														</span></a></div></td>
					...
					<ul class="pagination">
						...
						%>
						<li><a href="teamboardlist.do?command=teamboardlist&page=<%=a%>&teamcode=<%=t_code%>"><%=a%>
						</a></li>&nbsp;
						<%
							}
						%>
						...
						<div id="wrap">
							<div class="product-head">
								...
								<div class="subli logolistmargin">
									...
									<li><img src="img/<%=teamlist.get(i).getT_logo() %>" align="absmiddle" class="subli_img" /> <a href="teamboardlist.do?command=teamboardlist&teamcode=<%=teamlist.get(i).getT_code() %>&teamname=<%=teamlist.get(i).getT_name() %>" ><%=teamlist.get(i).getT_name() %></a></li>
									<%} %>
