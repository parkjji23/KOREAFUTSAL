			...
			<div id="matList">
				...
				<div class="cbox">
					<div class="write_wrap">
						...
						<form name="reg_form" id="reg_form" method="post" action="league_join_step3.do?command=league_join_step3">
							...
							<dl class="fl_left">
								...
								<dd>
									<span class="select" style="width:100%"> 
										<label for="select03">소속팀</label>
										<select id="select03" name="team_name"> 
										<option value="">소속팀</option>
						...
						<dl>
							...
							<dd>
								<span class="select" style="width:100%"> 
									...
									<select id="select02" name="league_name"> 
						...
						<div class="btn_wrap">
							<a href="javascript:validation();" class="btn_big" "="">등록하기</a>
						...
						$(document).ready(function() {
							...
							function validation() {
								var uniformnumcheck = /^[0-9]{1,2}$/;
								if(reg_form.team_name.value==""){
									alert("팀을 선택하세요. 가입된 팀이 없을경우 목록에 표시되지 않습니다.");
								}else if(reg_form.position.value==""){
									alert("포지션을 선택하세요.");
								}else if(!uniformnumcheck.test(reg_form.uniformnum.value)){
									alert("등번호를 올바르게 입력해주세요.0~99 숫자만 유효합니다.")
								}else if(reg_form.league_name.value==""){
									alert("리그를 선택하세요.")
								}else{
									league_step2_teamcheck();
								}
							}
