		...
		<section id="mainright" >
			<div id="matList" >
				...
				<div class="container margin1 fontsize" id="formOutterWrapper">
					<center>
						<h3 class="h_tit" style="font-weight:normal;">게시글 작성</h3>
					</center>
					<div class="container" id="formInnerWrapper">
						<form action="galwrite.bo" method="post" enctype="multipart/form-data" name="boardform" role="form">
							...
							<div class="form-group">
								...
								<div class="col-xs-6">
										<select name="teamcode" size="1" class=formInput
											...
											<option value="">팀 선택(가입된 팀에서 선택)</option>
							...
							<div class="form-group">
								...
								<div class="col-xs-4 buttonmargin">
									...
									<input type="button" onclick="galwrite()" value="등록" class="signbutton signbutton5 buttongal" style="font-size: 15px;"> <input type="button" value="취소" class="signbutton signbuttoncancel buttongal margin3" style="font-size: 15px;" onClick="script: location.href='galList.bo'">
								</div>
							</div>
