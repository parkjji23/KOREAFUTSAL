...
//	<!--js 파일 분리가 안돼서 어쩔수없이 이곳에 사용한 용병가입 창 js 파일 2020.01.09           + 유효성 검사 2020.01.16 by 종혁형-->
	function yongjoinsubmit()
	{
		...
		}else if(yTel1len<=0 ||!regPhone2.test(yongjoin.yTel2.value) ||!regPhone3.test(yongjoin.yTel3.value)){
			...
			<div id="matList">
				...
				<div class="container" id="formOutterWrapper">
					...
					<div class="container" id="formInnerWrapper">
						<form name="yongjoin" id="materialForm" class="form" method="post" action="aPro.bo" role="form" autocomplete="off" enctype="multipart/form-data">
							<div class="form-group">
								<div class="col-xs-2"></div>
								<div class="col-xs-4">
									<label class="labels" for="subject">제목</label> <input type="text" class="formInput" id="subject" name="subject" style="font-size:18px;">
								</div>
							...
							<div class="form-group">
								<div class="col-xs-2"></div>
								<div class="col-xs-4">
									 <input type="file" class="formInput" id="FILE" name="FILE" style="font-size:18px;">
								</div>
							</div>
							...
							<div class="form-group" style="height:284px;">
								...
								<div class="col-xs-4">
									...
									<textarea name="Contents" id="Contents" style="width:730px;resize:none; height:200px;" placeholder="메모를 입력하세요." ></textarea>
								</div>
