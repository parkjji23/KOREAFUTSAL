...
<%
	ArrayList<QnaDto> QnaDetaillist = (ArrayList<QnaDto>) request.getAttribute("QnaDetaillist");
%>
			...
			<div id="matList">
				...
				<div class="cbox">
					<div class="notice_wrap list">
						<center><div style="font-size:45px;margin-left:180px;">Q&A상세</div></center>
						...
						<div class="container" id="formInnerWrapper">
							...
							<table>
								...
								<tr style="padding: 15px 15px 22px 15px; border-bottom: 1px solid #d5d8dd;padding-left: 40px;">
									<td class="viewsubject" >작성자</td>
								</tr>
								
								<tr style="padding: 15px 15px 22px 15px; border-bottom: 1px solid #d5d8dd;padding-left: 40px;">
								<td style="font-weight:normal;"><%=QnaDetaillist.get(0).getQ_b_name()%></td>
								</tr>
								...
								<%=QnaDetaillist.get(0).getQ_b_email()%>
								</td>
								</tr>
								
								<tr style="padding: 15px 15px 22px 15px; border-bottom: 1px solid #d5d8dd;padding-left: 40px;">
										<td class="viewform" colspan="1">작성일자</td>	
								</tr>
								
								<tr style="padding: 15px 15px 22px 15px; border-bottom: 1px solid #d5d8dd;padding-left: 40px;">
								<td style="font-weight:normal;"><%=QnaDetaillist.get(0).getQ_b_date()%></td>
								</tr>
								
								<tr style="padding: 15px 15px 22px 15px; border-bottom: 1px solid #d5d8dd;padding-left: 40px;">
									<td class="viewform" colspan="1" >글비밀번호</td>
								</tr>
								
								<tr style="padding: 15px 15px 22px 15px; border-bottom: 1px solid #d5d8dd;padding-left: 40px;">
								<td style="font-weight:normal;"><%=QnaDetaillist.get(0).getQ_b_secretcode()%></td>
								</tr>
								
								<tr style="padding: 15px 15px 22px 15px; border-bottom: 1px solid #d5d8dd;padding-left: 40px;">
										<td class="viewform" colspan="1" >제목</td>
								</tr>
								
								<tr style="padding: 15px 15px 22px 15px; border-bottom: 1px solid #d5d8dd;padding-left: 40px;">
								<td style="font-weight:normal;"><%=QnaDetaillist.get(0).getQ_b_title()%></td>
								</tr>
								
								<tr>	
									<td class="viewform" colspan="1" > 내용</td>
								</tr>
								
								<tr style="padding: 15px 15px 22px 15px; border-bottom: 1px solid #d5d8dd;padding-left: 40px;">
								<td style="font-weight:normal;"><%=QnaDetaillist.get(0).getQ_b_contents()%></td>
								</tr>
								...
								<form action="SendEmail.adm?command=qnaSendEmail" method="post">
								
								<%-- &q_b_email=<%=QnaDetaillist.get(0).getQ_b_email()%>
								&q_b_title=<%=QnaDetaillist.get(0).getQ_b_title()%>
								&q_b_contents=<%=QnaDetaillist.get(0).getQ_b_contents()%>
								&q_b_name=<%=QnaDetaillist.get(0).getQ_b_name()%> --%>
								
								<tr style="padding: 15px 15px 22px 15px; border-bottom: 1px solid #d5d8dd;padding-left: 40px;">
								<td style="font-weight:normal;">
								<textarea rows="15" cols="120" name="q_b_reply"></textarea>
								</td>
								</tr>
